"""
Emotion + Eye Blink Detection + Voice AI Assistant
Author: Amr Elsersy
Updated: Threaded voice input + Groq LLM + Windows TTS
"""
...
# ---------------- GROQ ---------------- #
client = Groq(api_key="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")  # <-- Use your new API key
...
def voice_interaction(emotion):
    """
    Thread function to handle voice interaction with LLM
    """
    global voice_thread
    ...
    with voice_lock:
        voice_thread = None  # mark thread as finished
...
def main(args):
    ...
    while video.isOpened():
        ...
        for face in faces:
            ...
            # Trigger threaded voice interaction
        ...
        cv2.imshow("Emotion + Eye Blink AI Assistant", frame)
