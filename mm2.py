...
Author: Amr Elsersy
Updated: Serial communication integrated
"""
...
# ---------------- GROQ ---------------- #
client = Groq(api_key="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")  # <-- replace with your key
...
def speak(text):
    ...
    if ser:
        try:
            ser.write(b'2')  # signal speaking started
        except:
            pass
    ...
    if ser:
        try:
            ser.write(b'5')  # signal speaking ended
        except:
            pass
